...
module.exports = async (client, Database) => {
  ...
  console.log(`BETTEROI Conected! <3 || v` + require("../../package.json").version);
  console.log('Trabaja con las mismas funciones que AOI solo que con más funciones y mejor...')
  console.log('Creditos a LEREF, AYAKA, KINO, AZUSFIN, RUBEN (Creadores originales de AOI.JS) Copyright © Aoi.JS')
