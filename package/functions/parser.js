...
`,
  ...
  $giveawayExists: "Checks if a giveaway ID exists;$giveawayExists[id]",
  $usersWithDiscriminator: "Returns the list with the users with the same discriminator given;$usersWithDiscriminator[discirminator;separator(Optional);forceCache(yes/no) (Optional)]",
